var LR_lng = 'cn';
var LR_ssl = 1;
var LR_e164e='F6AA4E75032E4A438CB9136A41C664F7';if(typeof(LR_showfloat)=='undefined' || LR_showfloat!=1)var LR_showfloat = 1;
var LR_imgurl = 'https://dft.zoosnet.net/';
var LR_websiteid = 'DFT43255660';
var LR_siteid = '43255660';
var LR_sysurl = 'https://dft.zoosnet.net/';
var LR_js_pm = 'd';
var LR_3fdf0=LR_e164e.replace(/1/g,'3').replace(/0/g,'2');var LR_isMobile = 1;
...
var LR_a7f34=LR_3fdf0.replace(/4/g,'8').replace(/5/g,'3');var LR_BJKF=LR_a7f34.replace(/5/g,'6').replace(/7/g,'1');if(typeof(LR_cid) == 'undefined')
{
	var _lr_helpalt_on=unescape("");
	var _lr_helpsrc_on=unescape("http%3a%2f%2fdft.zoosnet.net%2fsite%2f43255660%2fmobileonlineimgsrc_cn.png");
	var _lr_helpalt_of=unescape("");
	var _lr_helpsrc_of=unescape("http%3a%2f%2fdft.zoosnet.net%2fsite%2f43255660%2fmobileofflineimgsrc_cn.png");
...
var data='jid='+LR_js_pm+'&id='+LR_siteid+'&sid='+LR_sid+'&cid='+LR_cid+'&lng='+LR_lng;
	data+='&p='+escape(location.href)+'&r='+lr_refer5237+'&e='+escape(LR_explain)+'&OACK='+LR_BJKF;
...
checkcount=-1;LR_inviteimgJS=0;LR_hcloopJS(LR_sysurl+'js/JS_Float.aspx',data);LR_explain='';
		...
		document.write('<link href="https://dft.zoosnet.net/js/JS5_1.css" rel="stylesheet" type="text/css" />');
var LR_MCount1 = 5000; 
...
function LR_showminiDiv(islrminimin) {
	...
	if(LR_Floaters[2].pms['html']=='')
	{
        ...
        if (LR_checkagent('15b93 safari|15b150 safari'))LR_GetObj('LRfloater2').style.position = 'absolute';
...
window.addEventListener('message', function (e) {
            ...
            if (lr_cmd.a == 'scroll3') {
                if (LR_GetObj('LRMINIWIN').style.display == 'none')
                    return;
                LR_miniH(lr_cmd.b);
                if (!LR_checkagent('15b93 safari|15b150 safari'))window.scrollTo(0, 9999);
                return;
            }
            if (lr_cmd.a == 'scroll2') {
         ...
         function LR_inputFocus() {
             ...
             if (!LR_checkagent('15b93 safari|15b150 safari'))setTimeout("window.scrollTo(0, 9999);", 300);
         }
